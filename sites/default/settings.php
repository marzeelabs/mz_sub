 ...
 *
 */
$drupal_hash_salt = '7hIB8fG1foxx2Ucy4zzsTm8IHUqqNdFSQN72nEb8MWk';
...
// Add more directives to include settings.php for each environment.
// You can also subgroup them, e.g. settings.pantheon.php, settings.acquia.php as main groups,
// and below us settings.pantheon.dev.php, settings.acquia.dev.php, etc.

$conf['install_profile'] = 'mz_sub';
